...
import {Dimensions, FlatList, ImageBackground, Platform, SafeAreaView, StatusBar, Text,View} from 'react-native';
...
export default class MeteorScreen extends Component{
    ...
    getMeteors=()=>{
        axios.get("https://api.nasa.gov/neo/rest/v1/feed?api_key=QrKgryzCTva0fskAH2dnqe6NxnTUK8e0O8ZPdvAf").then(response=>{
    ...
    render(){
        if(Object.keys(this.state.meteors).length===0){
            ...
            meteors.forEach(function(element){
                ...
                let threatScore=(diameter/element.close_approach_data[0].miss_distance.kilometers)*10^9
            ...
            return(
                <View style={styles.container}>
                    ...
                    <FlatList keyExtractor={this.keyExtractor} data={meteors} renderItem
                    ={this.renderItem} horizontal={true} />
